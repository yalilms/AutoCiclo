...
VALUES (
    ...
    (
        ...
        '2024-04-10',
        800.00,
        'Turbo certificado con garantía'
    ),
    (
        6,
        2,
...
VALUES (
        ...
        0,
        1,
        'Estantería A, nivel 2',
        'Volkswagen Golf 2015-2020, Audi A3 2014-2019',
        '/imagenes/piezas/motor123.png',
        'Motor diésel en perfecto estado, 80.000 km reales, completo con accesorios'
    ),
    (
        2,
        'MOT-002',
        ...
        0,
        1,
        'Zona motores, pasillo 3',
        'Peugeot 308 2012-2018, Citroën C4',
        NULL,
        'Motor diésel 120CV, revisado y garantizado'
    ),
    (
        3,
        'CAR-025',
        ...
        2,
        'Estantería A, nivel 2',
        'Renault Clio III generación',
        '/img/MOT001.jpg',
        'Puerta completa con cristal y mecanismos'
    ),
    (
        4,
        'CAR-026',
        ...
        0,
        2,
        'Zona carrocería, pasillo 1',
        'Seat Ibiza 2012-2016',
        NULL,
        'Capó en buen estado, sin golpes'
    ),
    (
        5,
        'CAR-027',
        ...
        0,
        3,
        'Estantería C, nivel 1',
        'Ford Focus 2010-2015, Seat León 2012-2016',
        NULL,
        'Parachoques original, con enganche'
    ),
    (
        6,
        'INT-340',
        ...
        'Universal (adaptable)',
        NULL,
        'Volante con controles de audio y crucero'
    ),
    (
        7,
        'INT-341',
        ...
        0,
        2,
        'Zona interior, pasillo 2',
        'Seat Ibiza FR, León FR',
        NULL,
        'Par de asientos deportivos, tapicería en buen estado'
    ),
    (
        8,
        'ELE-455',
        ...
        0,
        1,
        'Estantería D, nivel 3',
        'Ford Transit 2016-2020',
        NULL,
        'Faro con tecnología LED, lado derecho'
    ),
    (
        9,
        'ELE-456',
        ...
        0,
        3,
        'Zona electrónica, pasillo 4',
        'Universal (Bosch)',
        NULL,
        'Alternador 14V 120A, funciona perfectamente'
    ),
    (
        10,
        'RUE-550',
        'Disco de freno ventilado 280mm',
        'ruedas',
        150.00,
        0,
        5,
        'Zona frenos, estante bajo',
        'Universal deportivo',
        NULL,
        'Disco de competición Brembo'
    ),
    (
        11,
        'RUE-551',
        ...
        'Universal',
        NULL,
        'Neumático seminuevo con 6mm de profundidad'
    ),
    (
        12,
        'OTR-700',
        ...
        0,
        1,
        'Caja fuerte, estante especial',
        'Honda CBR 600-1000',
        NULL,
        'Turbo reparado y certificado, garantía 6 meses'
    );
...
--
ALTER TABLE `PIEZAS` MODIFY `id_pieza` int NOT NULL AUTO_INCREMENT;
